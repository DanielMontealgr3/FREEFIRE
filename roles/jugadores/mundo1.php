...
<body>
    ...
    <script>
        ...
        // async function validarEstadoPartida() {
        //     for (const sala of salas) {
        //         try {
        //             const response = await fetch("./estadoPartida.php", {
        //                 method: 'POST',
        //                 headers: {
        //                     'Content-Type': 'application/x-www-form-urlencoded'
        //                 },
        //                 body: `id_sala=${sala.id_sala}`
        //             });


        //             const textResponse = await response.text();
        //             console.log(`Respuesta cruda de sala ${sala.id_sala}:`, textResponse);

        //             const data = textResponse.json // Convertimos el JSON manualmente
        //             console.log(`Estado de la sala ${sala.id_sala}:`, data);



        //         } catch (error) {
        //             console.error(`Error al validar la sala ${sala.id_sala}:`, error);
        //         }
        //     }
        // }
